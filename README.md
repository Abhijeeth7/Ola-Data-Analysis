...
V_TAT: Vehicle Turnaround Time (Average).

C_TAT: Customer Turnaround Time (Average).
...
Remember to use the correct date (%m/%d/%Y) and time (%H:%i:%s) format strings during import.
